...
<body>
        ...
        <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="slide/a.jpg" class="d-block w-100" style="height: 550px;">
            </div>
            <div class="carousel-item">
              <img src="slide/b.jpg" class="d-block w-100" style="height: 550px;">
            </div>
            <div class="carousel-item">
              <img src="slide/c.jpg" class="d-block w-100" style="height: 550px;">
            </div>
          </div>
      ...
      <div class="col-md-4">
          ...
          <div class="col-md-12">
            <div class="row text-center">
              <div class="col-md-12 judul">
                <img src="slide/logoo.png" align="left" style="height: 60px;">
        ...
        <div class="row" style="border: 1px solid #e6e6e6; margin-top: 10px; background: #fff;">
          <div class="col-md-12 text-center">
            <p style="font-size: 14px; color: #999; padding-top: 5px;">Lupa Password ? <b><a href="a.php">Klik Disini.</a></b></p>
          </div>
        </div>
      </div>
    </div>
  ...
  if (isset($_POST['masuk'])) {
    ...
    $pws = $_POST['password'];
    // $status = $_POST['status'];
    $sql = mysqli_query($conn, "SELECT * FROM login where username ='$usr' and password = '$pws'");
    ...
    if ($count > 0) {
      ...
      if ($status == 'admin') {
        ...
        $_SESSION['id_login'] = $id_user;
        $_SESSION['username'] = $namauser;
        echo "<script>window.location.href='user/index.php?page=home';</script>";
      }
    } else {
  ...
  <script src="admin/assetss/js/jquery.min.js"></script>
